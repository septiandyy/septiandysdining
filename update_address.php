...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" class="box" placeholder="street" required maxlength="50" name="building">
      ...
      <input type="text" class="box" placeholder="province name" required maxlength="50" name="state">
